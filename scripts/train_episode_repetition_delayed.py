...
import torch
import train_loops.policy_loop_repeat_episodic_delayed as pr
...
def main():
    ...
    iterations_folder = f"{alg_config.algorithm}-{env_config.task}-{datetime.now().strftime('%y_%m_%d_%H-%M-%S')}-episode_reward_RN5-RF20_DE100"
