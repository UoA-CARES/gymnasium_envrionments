...
# Swish
swish_a_sac: MLPConfig = MLPConfig(
    layers=[
        TrainableLayer(layer_type="Linear", out_features=256),
        FunctionLayer(layer_type="SiLU"),
    ]
)
swish_a_td3: MLPConfig = MLPConfig(
    layers=[
        TrainableLayer(layer_type="Linear", out_features=256),
        FunctionLayer(layer_type="SiLU"),
        TrainableLayer(layer_type="Linear", in_features=256),
...
all_both_swish_a_sac: MLPConfig = MLPConfig(
    layers=[
        TrainableLayer(layer_type="Linear", out_features=256),
        FunctionLayer(layer_type="SiLU"),
        TrainableLayer(layer_type="Linear", in_features=256, out_features=256),
...
all_both_swish_a_td3: MLPConfig = MLPConfig(
    layers=[
        TrainableLayer(layer_type="Linear", out_features=256),
        FunctionLayer(layer_type="SiLU"),
        TrainableLayer(layer_type="Linear", in_features=256, out_features=256),
...
all_both_swish_c: MLPConfig = MLPConfig(
    layers=[
        TrainableLayer(layer_type="Linear", out_features=256),
        FunctionLayer(layer_type="SiLU"),
        TrainableLayer(layer_type="Linear", in_features=256, out_features=256),
...
all_actor_swish_a_sac: MLPConfig = MLPConfig(
    layers=[
        TrainableLayer(layer_type="Linear", out_features=256),
        FunctionLayer(layer_type="SiLU"),
        TrainableLayer(layer_type="Linear", in_features=256, out_features=256),
...
all_actor_swish_a_td3: MLPConfig = MLPConfig(
    layers=[
        TrainableLayer(layer_type="Linear", out_features=256),
        FunctionLayer(layer_type="SiLU"),
        TrainableLayer(layer_type="Linear", in_features=256, out_features=256),
...
all_actor_swish_c: MLPConfig = MLPConfig(
    layers=[
        TrainableLayer(layer_type="Linear", out_features=256),
        FunctionLayer(layer_type="ReLU"),
        TrainableLayer(layer_type="Linear", in_features=256, out_features=256),
...
all_critic_swish_a_sac: MLPConfig = MLPConfig(
    layers=[
        TrainableLayer(layer_type="Linear", out_features=256),
        FunctionLayer(layer_type="ReLU"),
        TrainableLayer(layer_type="Linear", in_features=256, out_features=256),
...
all_critic_swish_a_td3: MLPConfig = MLPConfig(
    layers=[
        TrainableLayer(layer_type="Linear", out_features=256),
        FunctionLayer(layer_type="ReLU"),
        TrainableLayer(layer_type="Linear", in_features=256, out_features=256),
...
all_critic_swish_c: MLPConfig = MLPConfig(
    layers=[
        TrainableLayer(layer_type="Linear", out_features=256),
        FunctionLayer(layer_type="SiLU"),
        TrainableLayer(layer_type="Linear", in_features=256, out_features=256),
...
first_both_swish_a_sac: MLPConfig = MLPConfig(
    layers=[
        TrainableLayer(layer_type="Linear", out_features=256),
        FunctionLayer(layer_type="SiLU"),
        TrainableLayer(layer_type="Linear", in_features=256, out_features=256),
...
first_both_swish_a_td3: MLPConfig = MLPConfig(
    layers=[
        TrainableLayer(layer_type="Linear", out_features=256),
        FunctionLayer(layer_type="SiLU"),
        TrainableLayer(layer_type="Linear", in_features=256, out_features=256),
...
first_both_swish_c: MLPConfig = MLPConfig(
    layers=[
        TrainableLayer(layer_type="Linear", out_features=256),
        FunctionLayer(layer_type="SiLU"),
        TrainableLayer(layer_type="Linear", in_features=256, out_features=256),
...
first_actor_swish_a_sac: MLPConfig = MLPConfig(
    layers=[
        TrainableLayer(layer_type="Linear", out_features=256),
        FunctionLayer(layer_type="SiLU"),
        TrainableLayer(layer_type="Linear", in_features=256, out_features=256),
...
first_actor_swish_a_td3: MLPConfig = MLPConfig(
    layers=[
        TrainableLayer(layer_type="Linear", out_features=256),
        FunctionLayer(layer_type="SiLU"),
        TrainableLayer(layer_type="Linear", in_features=256, out_features=256),
...
first_actor_swish_c: MLPConfig = MLPConfig(
    layers=[
        TrainableLayer(layer_type="Linear", out_features=256),
        FunctionLayer(layer_type="ReLU"),
        TrainableLayer(layer_type="Linear", in_features=256, out_features=256),
...
first_critic_swish_a_sac: MLPConfig = MLPConfig(
    layers=[
        TrainableLayer(layer_type="Linear", out_features=256),
        FunctionLayer(layer_type="ReLU"),
        TrainableLayer(layer_type="Linear", in_features=256, out_features=256),
...
first_critic_swish_a_td3: MLPConfig = MLPConfig(
    layers=[
        TrainableLayer(layer_type="Linear", out_features=256),
        FunctionLayer(layer_type="ReLU"),
        TrainableLayer(layer_type="Linear", in_features=256, out_features=256),
...
first_critic_swish_c: MLPConfig = MLPConfig(
    layers=[
        TrainableLayer(layer_type="Linear", out_features=256),
        FunctionLayer(layer_type="SiLU"),
        TrainableLayer(layer_type="Linear", in_features=256, out_features=256),
