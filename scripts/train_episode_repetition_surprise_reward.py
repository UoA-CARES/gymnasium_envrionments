...
import torch
import train_loops.policy_loop_repeat_episodic_surprise_reward as cpbe
...
def main():
    ...
    iterations_folder = f"{alg_config.algorithm}-{env_config.task}-{datetime.now().strftime('%y_%m_%d_%H-%M-%S')}-episode_surprise_reward_RF20_RN5_VEM10"
